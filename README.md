...
Репозиторий организован по модулям и темам. Материалы для каждого урока находятся в соответствующей директории:

- `M<номер_модуля>/T<номер_урока>/`

Например, директория `M1/Т2/` содержит материалы для второй темы первого модуля.
